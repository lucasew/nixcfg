...
stdenv.mkDerivation {
  ...
  unpackPhase = ''
    ...
    cp ${
      fetchurl {
        url = "https://raw.githubusercontent.com/mdn/webextensions-examples/main/borderify/icons/border-48.png";
        sha256 = "sha256-c3clkz319uDlIRI5u7s1AEkzT1W53ILVBkbsjs0fDUg=";
      }
    } icons/border-48.png
  '';
