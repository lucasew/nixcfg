...
let
  ...
  '';
  anboxPkg = pkgs.stdenv.mkDerivation rec {
    pname = "anbox";
    version = "unstable-2020-8-17";

    src = fetchFromGitHub {
      owner = pname;
      repo = pname;
      fetchSubmodules = true;
      rev = "5ab92efdacd571b4cb9e81845f4494d52489af39";
      sha256 = "0innqp5mbgk28kzr1fiyirj9pp7ib9f4xqfsvcj16xdq7i41m91c";
    };

    nativeBuildInputs = [
      makeWrapper cmake pkgconfig dbus boost libcap gtest systemd mesa glib
